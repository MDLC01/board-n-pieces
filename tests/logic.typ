...
#let immortal-draw = bnp.play("e4 e5 Nc3 Bc5 Na4 Bxf2 Kxf2 Qh4 Ke3 Qf4 Kd3 d5 Kc3 Qxe4 Kb3 Na6 a3 Qxa4 Kxa4 Nc5 Kb4 a5 Kxc5 Ne7 Bb5 Kd8 Bc6 b6 Kb5 Nxc6 Kxc6 Bb7 Kb5 Ba6 Kc6 Bb7")
#assert.eq(immortal-draw.positions.first().fen, bnp.starting-position.fen)
#assert.eq(immortal-draw.positions.at(17).fen, "r1b1k1nr/ppp2ppp/n7/3pp3/N3q3/PK6/1PPP2PP/R1BQ1BNR b kq - 0 9")
#assert.eq(immortal-draw.positions.last().fen, "r2k3r/1bp2ppp/1pK5/p2pp3/8/P7/1PPP2PP/R1BQ2NR w - - 5 19")
...
#assert.eq(
  bnp.play("e4 e6 d4 d5 e5 c5 c3 cxd4 cxd4 Bb4+ Nc3 Nc6 Nf3 Nge7 Bd3 O-O Bxh7+ Kxh7 Ng5+ Kg6 h4 Nxd4 Qg4 f5 h5+ Kh6 Nxe6+ g5 hxg6#")
    .positions.last().fen,
...
#let test-pgn(file-name, expected-last-position) = {
  ...
  assert.eq(g.positions.last().fen, expected-last-position)
}
